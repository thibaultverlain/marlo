    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="bg-[var(--color-bg-card)] rounded-[14px] border border-[var(--color-border)] shadow-[var(--shadow-card)] p-6 space-y-5">
        ...
        <div className="border-t border-[var(--color-border)] pt-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div><label className={labelClass}>Prix d'achat</label><div className="relative"><input type="number" step="0.01" value={form.purchasePrice} onChange={(e) => updateField("purchasePrice", e.target.value)} className={`${inputClass} pr-8`} /><span className="absolute right-3 top-1/2 -translate-y-1/2 text-sm text-zinc-500">€</span></div></div>
            <div><label className={labelClass}>Prix de vente visé</label><div className="relative"><input type="number" step="0.01" value={form.targetPrice} onChange={(e) => updateField("targetPrice", e.target.value)} className={`${inputClass} pr-8`} /><span className="absolute right-3 top-1/2 -translate-y-1/2 text-sm text-zinc-500">€</span></div></div>
          </div>
          {marginPreview && (
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            {[
              ...
              { value: "vendu", label: "Vendu", dot: "bg-rose-400", active: "bg-rose-500/12 text-rose-400 border-rose-500/30" },
