  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="bg-[var(--color-bg-card)] rounded-[14px] border border-[var(--color-border)] shadow-[var(--shadow-card)] p-6 space-y-5">
        ...
        </div>{commPreview!==null&&<div className="mt-3 p-3 bg-rose-500/[0.08] border border-indigo-500/20 rounded-lg text-sm text-rose-300">Commission estimée : <span className="font-semibold">{formatCurrency(commPreview)}</span></div>}</div>
