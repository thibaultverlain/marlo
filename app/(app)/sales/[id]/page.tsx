    ...
    <div className="max-w-3xl space-y-6">
      ...
      {product && (
        <div className="bg-[var(--color-bg-card)] rounded-xl border border-[var(--color-border)] p-6">
          ...
          <Link href={`/products/${product.id}`} className="flex items-center gap-4 p-3 rounded-lg hover:bg-[var(--color-bg-hover)] transition-colors -m-3">
      ...
      <div className="bg-[var(--color-bg-card)] rounded-xl border border-[var(--color-border)] p-6">
        ...
        {customer ? (
          <Link href={`/customers/${customer.id}`} className="flex items-center gap-4 p-3 rounded-lg hover:bg-[var(--color-bg-hover)] transition-colors -m-3">
