  ...
  return (
    <div className="max-w-3xl space-y-6">
      ...
      <div className="card-static p-6">
        ...
        {req.customerId && req.customerName ? <Link href={`/customers/${req.customerId}`} className="flex items-center justify-between p-3 -m-3 rounded-lg row-hover transition-colors"><p className="text-sm text-zinc-200">{req.customerName}</p><span className="text-xs text-rose-400">Voir →</span></Link> : <p className="text-sm text-zinc-500">Inconnu</p>}
      </div>
